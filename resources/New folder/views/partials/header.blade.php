                ...
                <div class="row d-flex align-items-center justify-content-between ">
                    ...
                    <div class="col-md-4 d-flex justify-content-center justify-content-md-start mb-3 mb-md-0">
                        <a class="ms-md-2 logo navbar-brand" href="/home">
                            <img src="pos/assets/img/buku1.png" height="35" />
                            <span style="color:#588200">{{ config('app.name') }}</span>
                        </a>
                    </div>
                    <!-- Left elements -->
                    ...
                    <div class="col-md-4 d-flex justify-content-center justify-content-md-end align-items-center">
                        <div class="d-flex">
                            ...
                            <a class="nav-link cart me-3" href="/cart">
                                <span><i style="color:#588200" class="bi bi-bag-fill fs-5"></i></span>
                                <span class="badge rounded-pill badge-notification bg-danger">1</span>
                            </a>

                            <!-- Dashboard -->
                            <a class="nav-link cart me-3 fs-5" href="/dashboard">
                                <span><i style="color:#588200" class="bi bi-shop-window"></i></span>
                            </a>
                                        ...
                                        <div class="card profile-area shadow-none">
                                            <div class="top-container mt-3">
                                                <img class="img-fluid profile-image"
                                                    ...
                                                    width="50">
                                                <div class="row ms-2 mb-2">
                                                    <h5 style="color:#588200" class="col name">
                                                        @if (auth()->user()->nickname === null)
                                                            {{ auth()->user()->username }}
                                                        @else
                                                            {{ auth()->user()->nickname }}
