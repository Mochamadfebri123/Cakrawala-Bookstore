...
<body>
  ...
  <main id="main" class="main">
    ...
    <section class="section">
            <form action="{{url('update_kategori',$data->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-lg-6">
                        @csrf
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{-- Image --}}
                                <h5 class="card-title fs-4">Ganti Gambar Kategori
                                    <br>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="form-floating mb-3">
                                            <input class="form-control" id="floatingInput" name="nama_kategori" type="text"
                                                placeholder="Masukkan Kategori" value="{{$data->nama_kategori}}">
